...
def test_user_me_corrupted_jwt(fastreg_phone_user, assert_response, corrupted, description):
...
def test_user_me_token_of_other_user(fastreg_phone_user, fastreg_email_user, assert_response):
